...
public class DummySource implements Source<Make>{
	...
	public Collection<Make> next() {
		...
		Styles style1= new Styles(12, "MarutiLX", 4,new MPG(11.111, 00000) , new Price(111.111, 11111.8899), "car", 2, "rear", "10LPg", "hello", "petrol", "MA");
		...
		Styles style1a= new Styles(16, "MarutiTX", 4,new MPG(11.111, 00000) , new Price(111.111, 2155111), "car", 2, "rear", "10LPg", "hii", "Diesel", "MA");
		...
		Styles style2= new Styles(13, "SwitDesire", 4,new MPG(455.333, 00000) , null, "car", 2, "rear", "10LPg", "hello", "Diesel", "Sw");
		...
		// 3rd 
				...
				Styles style3= new Styles(13, "AudiR8", 4,new MPG(455.333, 00000) , new Price(233456678.00054, 344562662), "car", 2, "rear", "10LPg", null, "Diesel", "Sw");
				...
				Styles style4= new Styles(13, "Ferrari", 4,new MPG(455.333, 00000) , null, "car", 2, "rear", "10LPg", "heelloo", "Diesel", "Sw");
				...
				Styles style5= new Styles(17654, "WagaonR", 4,new MPG(455.333, 00000) , null, "car", 2, "rear", "10LPg", "heelloo", "Diesel", "Sw");
				...
				Styles style6= new Styles(17654, "JeepLX", 4,new MPG(455.333, 00000) , new Price(233456678.00054, 344562662), null, 2, "rear", "10LPg", "heelloo", "Diesel", "Je");
