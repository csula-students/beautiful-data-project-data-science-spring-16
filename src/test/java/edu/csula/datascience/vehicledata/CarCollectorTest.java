...
public class CarCollectorTest {
	...
	public Collection<Make> next() {
		...
		Styles style2 = new Styles(13, "SwitDesire", 4, new MPG(455.333, 00000), new Price(0,0), "car", 2, "rear", "10LPg",
				"hello", "Diesel", "Sw");
		...
		Styles style3 = new Styles(13, "AudiR8", 4, new MPG(455.333, 00000), new Price(6678.54, 4357),
		...
		Styles style4 = new Styles(13, "Ferrari", 4, new MPG(455.333, 00000), new Price(22678.78, 0), "car", 4, "rear", "10LPg",
				"heelloo", "Diesel", "Sw");
		...
		Styles style5 = new Styles(17654, "WagaonR", 4, new MPG(455.333, 00000), new Price(0, 0), "car", 2, "rear", "10LPg",
				"heelloo", "Diesel", "Sw");
		...
		Styles style6 = new Styles(17654, "JeepLX", 4, new MPG(455.333, 00000), new Price(2678.054, 3362),
